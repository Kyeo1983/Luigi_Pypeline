...
class {{job}}_{{id}}(luigi.Task):
    ...
    def run(self):
        ...
        .format('{{param_in_body}}', '{{param_in_title}}', emailconf.sendername, emailconf.sender, smtpconf.host, smtpconf.port, smtpconf.username, smtpconf.password, emailconf.receiver, '{{param_in_recipient}}'), shell=True)
