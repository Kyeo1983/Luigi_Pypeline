...
class custom_officee_scrape_5(luigi.Task):
    ...
    def run(self):
        ...
        for i in range(8):
            try:
                translation.columns = [client.translate_text(parent=parent, contents=[x], target_language_code="en", source_language_code="ja").translations[0].translated_text for x in translation.columns]
                break
            except:
